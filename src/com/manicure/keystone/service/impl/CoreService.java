...
public class CoreService extends BaseService implements ICoreService {
	...
	public JSONObject getAccessToken(String appid, String appsecret) {
		...
		String response = HttpClientUtil.doHttpsPost(requestUrl, null, "UTF-8");
	...
	public String processRequest(HttpServletRequest request) {
		...
		try {
			...
			if (msgType.equals(MessageService.REQ_MESSAGE_TYPE_TEXT)) {
				...
				respContent = respContent.replace("REDIRECT_URI", Encoder.urlEncodeUTF8("http://barrieshieh.tunnel.mobi/Manicure/mobile/index"));
